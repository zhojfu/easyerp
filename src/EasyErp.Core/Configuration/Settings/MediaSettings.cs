namespace EasyErp.Core.Configuration.Settings
{
    public class MediaSettings : ISettings
    {
        ...
        /// <summary>
        /// Geta or sets a vaue indicating whether single (/content/images/thumbs/) or multiple (/content/images/thumbs/001/ and
        /// /content/images/thumbs/002/) directories will used for picture thumbs
        /// </summary>
